...
> This repository serves as a personal repository template. Pre-
...
_For more examples and usage, please refer to the [Documentation](https://github.com/username/yourproject/wiki)._
...
* Live: [https://zothsu.github.io/template/](https://zothsu.github.io/template/)
* Staging:
* Development:
...
Note: These add-on's are here for other readme documentaion that might have more design focused needs.
  ...
  ![GitHub](https://img.shields.io/github/license/zothsu/template)  Generates license dynamically according to repository indicated in URL
